...
watch(
  ...
  (val) => {
    ...
    form.bug_at = form.bug_at * 1000;
    form.market_time = form.market_time * 1000;
    form.allotment_time = form.allotment_time * 1000;
    form.winning_time = form.winning_time * 1000;
  },
  {
    immediate: true,
  }
