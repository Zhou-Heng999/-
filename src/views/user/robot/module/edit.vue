        ...
        <div v-loading="loading" class="new">
            <el-form ref="formRef" :model="form" :rules="rules" label-position="right" label-width="100px">
                ...
                <el-form-item label="账号" prop="account">
                    <el-input v-model="form.account" disabled type="text" placeholder="请输入账号" />
                </el-form-item>
...
watch(
    ...
    (val) => {
        if (val) {
            let {channel,account,nick,type,signature,faceurl} = props.info
            form.account = `${channel}#${account}`;
            form.nick = nick;
            form.type = type;
            form.signature = signature;
            form.faceurl = faceurl;
        }
    },
    {
        immediate: true,
