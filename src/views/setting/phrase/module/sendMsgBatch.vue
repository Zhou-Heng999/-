...
const column = [{ title: "常用语", key: "phrases" }];
...
const downloadTemplate = () => {
  ...
  a.href = "./static/phrases.xlsx"; //对应模板
...
const startImport = () => {
  ...
  newArr.forEach((item) => {
    form.phrases.push(item.phrases.toString());
  });
  // console.log("🚀 ~ startImport ~ newArr:", newArr)
  console.log("form.phrases..", JSON.stringify(form.phrases));
  $api.appPhrase
    .appPhraseBatchAdd({
