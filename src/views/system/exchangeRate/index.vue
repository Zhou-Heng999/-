<template>
  ...
  <div class="table-container">
    ...
    >
      ...
      <el-table-column prop="from_currency" label="持有"> </el-table-column>
      <el-table-column prop="from_tag" label="持有标识"> </el-table-column>
      <el-table-column prop="to_currency" label="兑换"> </el-table-column>
      <el-table-column prop="to_tag" label="兑换标识"> </el-table-column>
