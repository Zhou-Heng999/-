<template>
  <div class="table-container">
    ...
    >
      <el-table-column prop="c_index" width="50" label="序号"> </el-table-column>
      ...
      <!--<el-table-column prop="last_login_time" label="期限">-->
        <!--<template #default="scope">-->
          <!--{{scope.row.term_value}}-->
          <!--<el-tag v-if="scope.row.term_type==1" type="success">分</el-tag>-->
          <!--<el-tag v-else-if="scope.row.term_type==2" type="success">小时</el-tag>-->
          <!--<el-tag v-else-if="scope.row.term_type==3" type="success">天</el-tag>-->
          <!--<el-tag v-else type="success">年</el-tag>-->
        <!--</template>-->
      <!--</el-table-column>-->
