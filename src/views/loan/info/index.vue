<template>
  <div class="table-container">
    <div class="button-group">
      <el-button type="primary" :icon="Plus" @click="isAddShow = true">添加币种</el-button>
    </div>
    ...
    >
      ...
      <el-table-column prop="symbol" label="借贷币种"></el-table-column>
      <el-table-column prop="ratio" label="借款比例">
      ...
      <el-table-column prop="min_loan" label="最低借贷"></el-table-column>
      ...
      <el-table-column prop="is_online" label="是否上线">
        <template #default="scope">
          <el-button size="small" :type="scope.row.is_online == 1 ? 'success' : 'warning'">
      ...
      <el-table-column align="center">
        <template #default="scope">
          <el-button size="small" :type="scope.row.is_online == 1 ? 'warning' : 'success'" @click="handleOnline(scope.$index, scope.row)">
