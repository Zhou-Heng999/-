  ...
  >
    <div v-loading="loading" class="new">
      ...
      >
        ...
        <el-form-item label="质押币种" prop="symbol">
          <el-input
            v-model="form.symbol"
            placeholder="请输入币种符号"
          ></el-input>
        </el-form-item>
        <el-form-item label="最低质押" prop="min_pledge">
          <el-input
            v-model="form.min_pledge"
            placeholder="请输入最低质押"
          ></el-input>
        </el-form-item>
...
const rules = {
  ...
  min_pledge: [{ required: true, message: "请输入", trigger: "blur" }],
};
...
watch(
  () => props.info,
  (val) => {
    let { id, idx, symbol, ratio, min_pledge, other_json } = val;
    form.id = id;
    form.idx = idx;
    form.symbol = symbol;
    form.ratio = ratio;
    form.min_pledge = min_pledge;
    form.other_json = other_json;
    console.log("editInfo", form);
    editableTabs.value = form.other_json;
