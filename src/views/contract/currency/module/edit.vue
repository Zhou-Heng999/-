...
watch(
  ...
  (val) => {
    ...
    form.text = val.text;
    form.imageUrl = val.icon;

    form.show_percent = val.show_percent;
    form.open_deposit_percent = val.open_deposit_percent;
    form.open_fee_percent = val.open_fee_percent;
    form.init_price = val.init_price;
    form.min_price = val.min_price;
    form.max_price = val.max_price;

    form.min_percent = val.min_percent;
    form.max_percent = val.max_percent;
    form.change_type = val.change_type;
    form.change_value = val.change_value;
    form.open_rise_price = val.open_rise_price;

    form.open_rise_price_max = val.open_rise_price_max;
    (form.open_fall_price = val.open_fall_price),
      (form.open_fall_price_max = val.open_fall_price_max);
    form.count_value = val.count_value;

    (form.price_switch = val.price_switch), console.log("val:", val);
  },
  {
    immediate: true,
    deep: true,
