      ...
      <div v-loading="loading" class="new">
        ...
        <el-form-item label="昵称" prop="name">
          ...
          <el-form-item label="账号" prop="name">
            <el-input v-model="state.userInfo.account" disabled type="text" placeholder="" />
          </el-form-item>

          <el-form-item label="好友数" prop="name">
            <el-input v-model="state.userInfo.friend_count" disabled type="text" placeholder="" />
          </el-form-item>

          <el-form-item label="群聊数" prop="name">
            <el-input v-model="state.userInfo.group_count" disabled type="text" placeholder="" />
          </el-form-item>
          
          <el-form-item label="绑定手机" prop="name">
            <el-input v-model="state.userInfo.phone" disabled type="text" placeholder="" />
          </el-form-item>
          
          <el-form-item label="账号状态" prop="name">
            <el-input disabled type="text" :placeholder="state.userInfo.status==1? '正常': '封禁'" />
            <!-- <div>{{ state.userInfo.status==1? '正常': '封禁'}}</div> -->
          </el-form-item>

          <el-form-item label="封禁时间" prop="name">
            <el-input disabled type="text" :placeholder="setTimestamp(state.userInfo.update_status_time)" />
          </el-form-item>
          
          <el-form-item label="封禁操作人" prop="name">
            <el-input v-model="state.userInfo.update_status_opter" disabled type="text" placeholder="" />
          </el-form-item>
