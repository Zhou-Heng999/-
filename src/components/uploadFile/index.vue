<template>
	<div class="upload-file">
		<el-upload action="#" :before-upload="handleBeforeUpload" :file-list="fileList" :limit="limit" :show-file-list="false" class="upload-file-uploader" ref="upload">
			<!-- 上传按钮 -->
		...
		<!-- <ul class="upload-file-list el-upload-list el-upload-list--text">
			<template v-for="(file, index) in fileList">
				<li :key="file.uid" class="el-upload-list__item ele-upload-list__item-content">
					...
					<div class="ele-upload-list__item-content-action"><el-link :underline="false" @click="handleDelete(index)" type="danger">删除</el-link></div>
				</li>
			</template>
		</ul> -->
	</div>
